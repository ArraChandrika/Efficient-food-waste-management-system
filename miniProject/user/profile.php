    ...
    <!-- <section class="cover" >
     ...
     -->
        <div class="profilebox" style="">
            ...
            <p class="headingline" style="text-align: left;font-size:30px;"> <img src="img\user.png" alt="" style="width:40px; height:  height: 25px;; padding-right: 10px; position: relative;" >Profile</p>
<!--             
