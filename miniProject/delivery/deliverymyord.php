...
<header>
    ...
    <nav class="nav-bar">
        <ul>
            ...
            <li><a href="../logout.php" class="logout-button">Logout</a></li> <!-- Logout button -->
        </ul>
    </nav>
</header>
<br>
...
<div class="get">
    ...
    <div class="log">
        <a href="delivery.php">Take New Orders</a>
        <p>Your Assigned Orders</p>
        <br>
    </div>
        ...
        <div class="table-wrapper">
            <table class="table">
                ...
                <tbody>
                    <?php if (empty($data)) { ?>
                        <tr>
                            <td colspan="5" style="text-align:center;">No orders assigned to you.</td>
                        </tr>
                    <?php } else {
                        foreach ($data as $row) { ?>
                            <tr>
